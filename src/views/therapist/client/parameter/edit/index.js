...
const EditClientParameter = () => {
  ...
  <>
    <Card>
      <CardHeader>
        <h4 className="mb-2">Edit Client Parameter</h4>
      </CardHeader>
        <CardBody>
          <Form>
            {/* Vital Signs */}
        ...
        <CardFooter>
          ...
          <Button color="secondary" onClick={() => history.push('/therapist-auth/client/parameter/list')}>
              Cancel
            </Button>
...
export default EditClientParameter
