...
import {
  ...
  DropdownToggle,
  DropdownMenu,
  DropdownItem, InputGroup, InputGroupText, InputGroupAddon
} from 'reactstrap'
...
const PaymentHistoryList = () => {
    ...
    const [viewReScheduleModal, setViewReScheduleModal] = useState(false)
...
const openView = row => {
  ...
  const openEdit = row => {
   ...
   const handleCancelSession = row => {
    MySwal.fire({
      title: 'Cancel Session?',
      text: `Cancel "${row.class_name}"?`,
      icon: 'warning',
...
const columns = getColumns({
  ...
  return (
    ...
    <Fragment>
        ...
        <Card>
            <CardHeader>
              <CardTitle tag="h4">Therapy Session History</CardTitle>
    ...
    <Modal
        isOpen={viewReScheduleModal}
        toggle={() => setViewReScheduleModal(!viewReScheduleModal)}
        size="lg"
        centered
      >
        <ModalHeader toggle={() => setViewReScheduleModal(false)}>
          Re-Schedule Therapy Session
        </ModalHeader>
        ...
        <ModalBody>
          ...
          <div className="view-details-wrapper">
            ...
            <Row className='mb-2'>
              <Col md="6" className="label">Current Scheduled Date & Time</Col>
              <Col md="6">
            ...
            <Row>
              <Col md="6">
                <FormGroup>
                    <Fragment>
                    <Label>
                      New Start Date & Time <span className="text-danger">*</span>
                    </Label>
                    ...
                    <InputGroup style={{ cursor: 'pointer' }}>
                      <Flatpickr
                        ...
                        placeholder="Select New Schedule Date & Time"
                      />
              ...
              <Col md="6">
                <FormGroup>
                  <Label>
                    New End Date & Time <span className="text-danger">*</span>
                  </Label>
        ...
        <ModalFooter>
          <Button color="secondary" onClick={() => setViewReScheduleModal(false)}>
            Close
          </Button>
        </ModalFooter>
      </Modal>
