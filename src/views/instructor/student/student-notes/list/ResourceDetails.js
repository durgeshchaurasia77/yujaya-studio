...
const ResourceDetails = () => {
  return (
    <div className="resource-details">
      ...
      <Row>
        <Col md="4" className="label">Class Code</Col>
        <Col md="8">qw123</Col>
      </Row>

      <Row>
        <Col md="4" className="label">Document Title</Col>
        <Col md="8">Yoga Asana Practice Kit</Col>
      </Row>

      <Row>
        <Col md="4" className="label">Document Type</Col>
        <Col md="8">Class Practice Kit</Col>
      </Row>
