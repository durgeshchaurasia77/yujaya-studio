...
const StudioEdit = () => {
  ...
  return store.selectedStudio !== null && store.selectedStudio !== undefined ? (
        ...
        <Card>
          <CardBody className='pt-2'>
            ...
            <TabContent activeTab={activeTab}>
              <TabPane tabId='1'>
                <AccountTab selectedStudio={store.selectedStudio} />
              </TabPane>
              <TabPane tabId='2'>
                <InfoTab />
              </TabPane>
    ...
    <Alert color='danger'>
      ...
      <div className='alert-body'>
        User with id: {id} doesn't exist. Check list of all Users: <Link to='/studio/list'>Studio List</Link>
      </div>
    </Alert>
  )
}
