...
const StudioAccountTab = ({ selectedStudio }) => {
  // ** States
  ...
  // ** Update studio image on mount or change
  useEffect(() => {
    if (selectedstudio !== null || (selectedstudio !== null && studioData !== null && selectedstudio.id !== studioData.id)) {
      setstudioData(selectedstudio)
      if (selectedstudio.avatar.length) {
        return setImg(selectedstudio.avatar)
      } else {
        return setImg(null)
      }
    }
    ...
    if (img === null) {
      ...
      return (
        <Avatar
          ...
          content={selectedstudio.fullName}
          contentStyles={{
            borderRadius: 0,
            fontSize: 'calc(36px)',
            width: '100%',
      ...
      return (
        <img
          className='studio-avatar rounded mr-2 my-25 cursor-pointer'
          src={img}
          alt='studio profile avatar'
          height='90'
          width='90'
        />
      )
          ...
          <Row>
            <Col md='4' sm='12'>
              <FormGroup>
                ...
                <Input type='text' id='username' placeholder='Username' defaultValue={studioData && studioData.username} />
              </FormGroup>
            </Col>
            <Col md='4' sm='12'>
              <FormGroup>
                <Label for='name'>Name</Label>
                <Input type='text' id='name' placeholder='Name' defaultValue={studioData && studioData.fullName} />
              </FormGroup>
            </Col>
            <Col md='4' sm='12'>
              <FormGroup>
                <Label for='email'>Email</Label>
                <Input type='text' id='email' placeholder='Email' defaultValue={studioData && studioData.email} />
              </FormGroup>
            </Col>
            <Col md='4' sm='12'>
              <FormGroup>
                <Label for='status'>Status</Label>
                <Input type='select' name='status' id='status' defaultValue={studioData && studioData.status}>
            ...
            <Col md='4' sm='12'>
              <FormGroup>
                ...
                <Input type='select' name='role' id='role' defaultValue={studioData && studioData.role}>
            ...
            <Col md='4' sm='12'>
              <FormGroup>
                ...
                <Input
                  type='text'
                  id='company'
                  defaultValue={studioData && studioData.company}
...
export default StudioAccountTab
