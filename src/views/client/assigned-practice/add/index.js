      ...
      <CardBody>
        ...
        <CardFooter className="text-end">
          <div className="d-flex justify-content-between align-end button-alignment-accouncement">
            <Button color="secondary" onClick={() => history.push('/client-auth/client/therapy-plan/list')} className='mr-2'>
            Cancel
            </Button>
              <Button color="primary" onClick={() => history.push('/client-auth/client/therapy-plan/list')}>Submit</Button>
            </div>
        </CardFooter>
    </Card>
  </>
