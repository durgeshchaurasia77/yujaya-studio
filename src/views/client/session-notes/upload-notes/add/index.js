    ...
    <Card>
      ...
      <CardFooter className="text-end">
        <div className="d-flex justify-content-between align-end button-alignment-accouncement">
          <Button color="secondary" className='mr-2' onClick={() => history.push('/client-auth/session-notes/upload-notes/list')}>
            Cancel
          </Button>
          <Button color="primary" onClick={() => history.push('/client-auth/session-notes/upload-notes/list')}>
            Submit
          </Button>
        </div>
